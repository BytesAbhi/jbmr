  ...
  return (
    <>
       <div className="heading_card" style={{marginTop:'1.5rem'}}>
        <h2 style={{ padding: '0rem 0.5rem',borderLeft:'4px solid rgb(255,80,0)' }}>Live Score</h2>
      </div>
      ...
      <div className="carousel-container">
        ...
        <div className="cards-display" >
          {cards.slice(currentIndex, currentIndex + 4).map((card, index) => (
            <div key={index} className="LiveScore_card">
              ...
              <div className="cards_content">
                ...
                <div className="imgAndCountry">
                  ...
                  <div className="LiveScore_Country-line">
                    <div style={{display:'flex',alignItems:'center',lineHeight:'2rem'}}>
                    <img className="LiveScore_SetCountryImg" src={card.country1.image} alt="" />
                    <span className="LiveScore_country_name">{card.country1.name}</span>
                    </div>
                    <div>
                        <span className="LiveScore_country_score">{card.score}</span>
                    </div>
                  </div>
